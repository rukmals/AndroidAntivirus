...
public class AppScanner extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final AppScanner something = this;
...
//			Log.v("VELICINA" , "VELICINA "+can_see_location_info_obj.size());
            ...
            Intent myIntent = new Intent(AppScanner.this, Result.class);
